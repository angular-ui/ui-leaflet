...
We can define also some other defaults, like the default tileLayer url where the tiles will be fetched, or the zoom control position on the map. You can see the list of all the default parameters [here](https://github.com/angular-ui/ui-leaflet/blob/master/src/services/leafletMapDefaults.js#L2).
